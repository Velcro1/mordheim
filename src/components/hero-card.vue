  ...
  <b-row>
    <b-col class="wb-container" cols="12">
      <b-row>
        <b-col cols="4">
          <b-row>
            <b-col id="hero-name" class="hero-name p-2" cols="12" md="12"
              >NAME</b-col
            >
          </b-row>
          <b-row>
            <b-col class="hero-type p-2" cols="12" md="12"
              >TYPE <span>{{ hero.type }}</span></b-col
            >
          </b-row>
          <b-row>
        ...
        <b-col class="hero-equip p-2" cols="4"
          >EQUIPMENT
          <button @click="toggleEquipmentModal">Add Equipment</button>
          <EquipmentModal v-show="getEquipmentModalState" />
        </b-col>
        <b-col class="hero-skills p-2" cols="4"
          >SKILLS, INJURIES, ETC
          <ul class="skills">
            <li v-for="specialRule in hero.specialRules" :key="specialRule">
              {{ specialRule }}
            </li>
          </ul>
        </b-col>
